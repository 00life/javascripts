class Preload extends Phaser.Scene {
    ...
    preload() {
        this.load.tilemapTiledJSON('level_1', 'assets/darko_3.json');
        this.load.tilemapTiledJSON('level_2', 'assets/darko_2.json');
        ...
        this.load.spritesheet('player-slide-sheet', 'assets/player/slide_sheet_copy.png', {
            frameWidth: 32, frameHeight: 38, spacing: 32
        });
        ...
        this.load.audio('collect', 'assets/music/coin_pickup.wav');
