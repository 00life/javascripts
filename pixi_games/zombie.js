...
export default class Zombie {
  constructor({ app, player }) {
    ...
    let path_z = `assets/${zombieName}.json`;
    let sheet = PIXI.Loader.shared.resources[path_z].spritesheet;
